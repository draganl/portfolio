import { defineComponent, withAsyncContext, unref, mergeProps, computed, toRaw, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { r as pascalCase, v as kebabCase, x as destr } from '../nitro/nitro.mjs';
...
const Alert = () => import('./Alert-qmjKwpdD.mjs');
const Counter = () => import('./Counter-DdkX7iQC.mjs');
...
const localComponents = ["Alert", "Counter"];
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    }, "$vHqkxevve1")), __temp = await __temp, __restore(), __temp);
    if (!page.value) {
...
//# sourceMappingURL=_...slug_-BSeGVCb4.mjs.map
