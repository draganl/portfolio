...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "615cb042-7fca-48bd-bf96-bcfd9635f23d",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/api/content/content/database.sql": {
        "prerender": true
      },
      "/api/content/projects/database.sql": {
        "prerender": true
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/home/dragan/portfolio/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/dragan/portfolio/.data/kv"}));
...
const _i147Kf = eventHandler(async (event) => {
...
function loadDatabaseAdapter(config) {
  ...
  let db;
  if (["nitro-prerender", "nitro-dev"].includes("netlify-legacy")) {
  ...
  return {
    all: async (sql, params = []) => {
      return db.prepare(sql).all(...params).then((result) => "results" in result && Array.isArray(result.results) ? result.results : result).then((result) => (result || []).map((item) => refineContentFields(sql, item)));
    },
...
const _emXGej = eventHandler(async (event) => {
...
const _lazy_S5eAqG = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_S5eAqG, lazy: true, middleware: false, method: undefined },
  { route: '/api/content/:collection/database.sql', handler: _i147Kf, lazy: false, middleware: false, method: undefined },
  { route: '/api/content/:collection/query', handler: _emXGej, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_S5eAqG, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withTrailingSlash as A, parseQuery as B, handler as C, getRouteRules as a, buildAssetsURL as b, createError$1 as c, defineRenderHandler as d, useNitroApp as e, getResponseStatusText as f, getQuery as g, getResponseStatus as h, hasProtocol as i, isScriptProtocol as j, joinURL as k, getContext as l, baseURL as m, createHooks as n, createRouter$1 as o, publicAssetsURL as p, defu as q, pascalCase as r, sanitizeStatusCode as s, toRouteMatcher as t, useRuntimeConfig as u, kebabCase as v, withQuery as w, destr as x, withoutTrailingSlash as y, withLeadingSlash as z };
